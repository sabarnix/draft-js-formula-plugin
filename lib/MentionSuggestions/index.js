  ...
  function MentionSuggestions() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = MentionSuggestions.__proto__ || Object.getPrototypeOf(MentionSuggestions)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      ...
      var selectionIsInsideWord = leaves.filter(function (leave) {
        ...
        return matchingPositions.some(function (position) {
      ...
      var _getSearchText = (0, _getSearchText3.default)(editorState, selection),
          searchValue = _getSearchText.searchValue;
      ...
      newIndex = _this.props.onSuggestionDownArrow ? _this.props.onSuggestionDownArrow(newIndex) : newIndex;
      newIndex = newIndex >= _this.props.suggestions.filter(function (x) {
        return x;
      }).size ? newIndex - 1 : newIndex;
      _this.onMentionFocus(newIndex);
      _this.adjustScroll(newIndex);
      ...
      if (_this.props.suggestions.size > 0) {
        var newIndex = _this.state.focusedOptionIndex - 1;
        newIndex = _this.props.onSuggestionUpArrow ? _this.props.onSuggestionUpArrow(newIndex) : newIndex;
        newIndex = newIndex < 0 ? newIndex + 1 : newIndex;
        _this.onMentionFocus(newIndex);
        _this.adjustScroll(newIndex);
      }
    }, _this.adjustScroll = function (index) {
      var optionEle = _this.popover.querySelectorAll('[role="option"]')[index];
      if (!optionEle) return;
      if (optionEle.offsetTop > _this.popover.scrollTop + (_this.popover.offsetHeight - 10)) {
        _this.popover.scrollTop += optionEle.offsetHeight + 10;
      } else if (optionEle.offsetTop < _this.popover.scrollTop + 10) {
        _this.popover.scrollTop -= optionEle.offsetHeight + 10;
      }
      ...
      if (_this.props.onAddMention) {
        mention = _this.props.onAddMention(mention);
      }
  ...
  _createClass(MentionSuggestions, [{
    ...
    value: function render() {
      ...
      var _props = this.props,
          ...
          onSuggestionUpArrow = _props.onSuggestionUpArrow,
          onSuggestionDownArrow = _props.onSuggestionDownArrow,
          elementProps = _objectWithoutProperties(_props, ['entryComponent', 'popoverComponent', 'onClose', 'onOpen', 'onAddMention', 'onSearchChange', 'suggestions', 'ariaProps', 'callbacks', 'theme', 'store', 'entityMutability', 'positionSuggestions', 'mentionTrigger', 'mentionPrefix', 'onSuggestionUpArrow', 'onSuggestionDownArrow']);
      ...
      return _react2.default.cloneElement(popoverComponent, _extends({}, elementProps, {
        ...
        return mention && _react2.default.createElement(_Entry2.default, {
...
MentionSuggestions.propTypes = {
  ...
  onSuggestionUpArrow: _propTypes2.default.func,
  onSuggestionDownArrow: _propTypes2.default.func,
